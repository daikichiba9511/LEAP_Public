...
class LeapUnet1D(nn.Module):
    def __init__(self, in_chans: tuple[int, ...] = (25, 32, 64, 128, 256, 512)) -> None:
        ...
        self.cnn1 = nn.Conv1d(in_chans[1], in_chans[0], kernel_size=3, padding=1)
        self.cnn2 = nn.Conv1d(in_chans[0] * 2, 14, kernel_size=3, padding=1)
...
if __name__ == "__main__":
    ...
    in_chans = (25, 128, 256, 512, 1024, 2048)
