...
006
    ...
    + middleをTransformerEncoderに変更 (080)
"""
...
class Config(pydantic.BaseModel):
    ...
    train_batch_size: int = pydantic.Field(default=1024 * 1, description="train batch size")

    # -- Valid
    valid_batch_size: int = pydantic.Field(default=1024 * 1, description="valid batch size")
